...
const disableBlocks = {
    debug: ["audio_player_rj25.audioplayer_init", "audio_player_rj25.audioplayer_play_by_sn", "audio_player_rj25.audioplayer_play_by_name", "audio_player_rj25.audioplayer_set_play_mode", "audio_player_rj25.audioplayer_play_previous", "audio_player_rj25.audioplayer_play_next", "audio_player_rj25.audioplayer_pause", "audio_player_rj25.audioplayer_stop", "audio_player_rj25.audioplayer_set_volume", "audio_player_rj25.audioplayer_volume_up", "audio_player_rj25.audioplayer_volume_down", "audio_player_rj25.audioplayer_record", "audio_player_rj25.audioplayer_record_stop"],
    upload: []
};
...
class ExtAudioPlayerRj25 {
    ...
    constructor() {
        this.funcs = {
            ...
            'audioplayerPlayBySnCodesCode': (args) => {
                if (args.FILE_SN == "None") {
                    args.FILE_SN = 0;
                } else if (Number(args.FILE_SN) < 0) {
                    args.FILE_SN = 0;
                }
                // args.FILE_SN = parseInt(args.FILE_SN);
                return `
meAudioPlayer.playMusicFileIndex(${args.FILE_SN});
_delay(0.1);`
            },
            'audioplayer_play_by_sn': {
                onRun: (args, app, device, block) => {
                    // TODO
                }
            },
            'audioplayer_play_by_name': {
                onRun: (args, app, device, block) => {
                    // TODO
                }
            },
            'audioplayer_set_play_mode': {
                onRun: (args, app, device, block) => {
                    // TODO
                }
            },
            'audioplayer_play_previous': {
                onRun: (args, app, device, block) => {
                    // TODO
                }
            },
            'audioplayer_play_next': {
                onRun: (args, app, device, block) => {
                    // TODO
                }
            },
            ...
            'audioplayerSetVolumeCodesCode': (args) => {
                if (args.VOLUME == "None") {
                    args.VOLUME = 0;
                } else if (Number(args.VOLUME) < 0) {
                    args.VOLUME = 0;
                } else if (Number(args.VOLUME) > 100) {
                    args.VOLUME = 100;
                }
                // args.VOLUME = parseInt(args.VOLUME);
                return `
meAudioPlayer.setMusicVolume(${args.VOLUME});
_delay(0.1);`
            },
            ...
            'audioplayer_volume_up': {
                onRun: (args, app, device, block) => {
                    // TODO
                }
            },
            'audioplayer_volume_down': {
                onRun: (args, app, device, block) => {
                    // TODO
                }
            },
...
export default ExtAudioPlayerRj25;