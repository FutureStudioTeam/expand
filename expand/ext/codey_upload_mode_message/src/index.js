...
async function subscribeLowerComputerMessage() {
    await engine.subscribeReadProtocol('f3f4', [uploadMessageID, 'string0'], (values) => {
        if (values === null) {
            return null;
        }
        try {
...
const disableBlocks = {
    debug: ["codey_upload_mode_message.SendUploadModeMessage", "codey_upload_mode_message.SendUploadModeMessageWithValue", "codey_upload_mode_message.whenReceivingUploadModeMessage ", "codey_upload_mode_message.UploadModeMessageValue"],
    upload: []
};
...
class ExtCodeyUploadModeMessage {

    constructor() {
        this.funcs = {
            'SendUploadModeMessage': {
                onRun: (args, app, device, block) => {
                    // TODO
                }
            },
            'SendUploadModeMessageWithValue': {
                onRun: (args, app, device, block) => {
                    // TODO
                }
            },
            'whenReceivingUploadModeMessage': {
                onRun: (args, app, device, block) => {
                    // TODO
                },
...
export default ExtCodeyUploadModeMessage;