...
const halocodeMbuildFlameSensorHaloboardUploadMiddlewareTemp =
    /**
...
function updateShareDatas() {
    ...
    let mbuildFlameSensorTable = [
        new onlineDataStructure("BLOCK_1560259418555", "mbuild.flame_sensor.is_active", [1], {
            default: "bool"
        }),
        new onlineDataStructure("BLOCK_1560259595150", "mbuild.flame_sensor.get_value", [1], {
            default: "int"
        }),
    ]


    onlineManager.updateOnlineTable("add", mbuildFlameSensorTable);
}
...
class ExtHalocodeMbuildFlameSensor {
        ...
        this.funcs = {
            'BLOCK_1560259418555': {
                onRun: (args, app, device, block) => {
                    ...
                    let opcode = "BLOCK_1560259418555";
            ...
            'BLOCK_1560259595150': {
                onRun: (args, app, device, block) => {
                    ...
                    let para = [Number(args.index)];
                    let opcode = "BLOCK_1560259595150";
    ...
    getInfo() {
        return {
            "id": "halocode_mbuild_flame_sensor",
            "targets": [
                "haloboard",
                "cyberpi"
            ],
...
export default ExtHalocodeMbuildFlameSensor;