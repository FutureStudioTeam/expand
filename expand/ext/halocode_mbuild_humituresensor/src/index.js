...
const halocodeMbuildHumituresensorHaloboardUploadMiddlewareTemp =
    /**
...
function updateShareDatas() {
    ...
    let mbuildHumitureTable = [
        // "celsius", {index}
        new onlineDataStructure("op_temperature", "mbuild.humiture_sensor.get_temperature", ["celsius", 1], {
            default: "int"
        }),
        new onlineDataStructure("op_htemperature", "mbuild.humiture_sensor.get_temperature", ["fahrenheit", 1], {
            default: "int"
        }),
        new onlineDataStructure("op_humidity", "mbuild.humiture_sensor.get_relative_humidity", [1], {
            default: "int"
        }),
    ]

    onlineManager.updateOnlineTable("add", mbuildHumitureTable);
}
...
class ExtHalocodeMbuildHumituresensor {
        ...
        this.funcs = {
            'op_temperature': {
                onRun: (args, app, device, block) => {
                    ...
                    let para = ["celsius", Number(args.index)];
                    let opcode = "op_temperature";
            ...
            'op_htemperature': {
                onRun: (args, app, device, block) => {
                    ...
                    let para = ["fahrenheit", Number(args.index)];
                    let opcode = "op_htemperature";
    ...
    getInfo() {
        return {
            "id": "halocode_mbuild_humituresensor",
            "targets": [
                "haloboard",
                "cyberpi"
            ],
...
export default ExtHalocodeMbuildHumituresensor;