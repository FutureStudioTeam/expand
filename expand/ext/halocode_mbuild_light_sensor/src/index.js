...
const halocodeMbuildLightSensorHaloboardUploadMiddlewareTemp =
    /**
...
function updateShareDatas() {
    ...
    let mbuildLightSensorTable = [
        new onlineDataStructure("BLOCK_1559813805438", "mbuild.light_sensor.get_value", [1], {
            default: "int"
        }),
    ]

    onlineManager.updateOnlineTable("add", mbuildLightSensorTable);
}
...
class ExtHalocodeMbuildLightSensor {
        ...
        this.funcs = {
            'BLOCK_1559813805438': {
                onRun: (args, app, device, block) => {
                    ...
                    let opcode = "BLOCK_1559813805438";
    ...
    getInfo() {
        return {
            "id": "halocode_mbuild_light_sensor",
            "targets": [{
                    "name": "haloboard",
                    "options": {
                        "upload": {
                            "middlewares": [{
                                "name": "temp",
                                "func": halocodeMbuildLightSensorHaloboardUploadMiddlewareTemp
                            }]
                        }
                    }
                },
...
export default ExtHalocodeMbuildLightSensor;