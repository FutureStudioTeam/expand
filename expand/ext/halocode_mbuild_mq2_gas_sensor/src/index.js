...
const halocodeMbuildMq2GasSensorHaloboardUploadMiddlewareTemp =
    /**
...
function updateShareDatas() {
    ...
    let mbuildGasSensorTable = [
        // {sen}, {index}  -- low high
        new onlineDataStructure("BLOCK_1560258942584", "mbuild.mq2_gas_sensor.is_active", ['low', 1], {
            default: "bool"
        }),
    ]

    onlineManager.updateOnlineTable("add", mbuildGasSensorTable);
}
...
class ExtHalocodeMbuildMq2GasSensor {
        ...
        this.funcs = {
            'BLOCK_1560258942584': {
                onRun: (args, app, device, block) => {
                    ...
                    let para = [args.sen, Number(args.index)];
                    let opcode = "BLOCK_1560258942584";
    ...
    getInfo() {
        return {
            "id": "halocode_mbuild_mq2_gas_sensor",
            "targets": [
                "haloboard",
                "cyberpi"
            ],
...
export default ExtHalocodeMbuildMq2GasSensor;