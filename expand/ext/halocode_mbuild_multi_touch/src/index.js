...
const halocodeMbuildMultiTouchHaloboardUploadMiddlewareTemp =
    /**
...
function updateShareDatas() {
    ...
    let mbuildMultiTouchTable = [
        // {tp_num}, {index}
        new onlineDataStructure("BLOCK_1559810784185", "mbuild.multi_touch.is_active", [1, 1], {
            default: "bool"
        }),
        // {sensitivity}, {index}
        new onlineDataStructure("BLOCK_1559811080887", "mbuild.multi_touch.set_sensitivity", [4, 1]),
    ]

    onlineManager.updateOnlineTable("add", mbuildMultiTouchTable);
}
...
class ExtHalocodeMbuildMultiTouch {
        ...
        this.funcs = {
            'BLOCK_1559810784185': {
                onRun: (args, app, device, block) => {
                    ...
                    let para = [Number(args.tp_num), Number(args.index)];
                    let opcode = "BLOCK_1559810784185";

                    onlineManager.parasUpdate(opcode, para, args.tp_num + args.index);
                    let value = onlineManager.getValue(opcode, args.tp_num + args.index);
                    return value;
                },
            ...
            'BLOCK_1559811080887': {
                onRun: async (args, app, device, block) => {
                    ...
                    let opcode = "BLOCK_1559811080887";
                    let para = [Number(args.sensitivity), Number(args.index)];
    ...
    getInfo() {
        return {
            "id": "halocode_mbuild_multi_touch",
            "targets": [
                "haloboard",
                "cyberpi"
            ],
...
export default ExtHalocodeMbuildMultiTouch;