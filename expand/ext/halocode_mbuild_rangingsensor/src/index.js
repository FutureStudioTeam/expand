...
const halocodeMbuildRangingsensorHaloboardUploadMiddlewareTemp =
    /**
...
function updateShareDatas() {
    ...
    let mbuildRangingSensorTable = [
        new onlineDataStructure("op_ranging", "mbuild.ranging_sensor.get_distance", [1], {
            default: "int"
        }),
    ]
    onlineManager.updateOnlineTable("add", mbuildRangingSensorTable);
}
...
class ExtHalocodeMbuildRangingsensor {
    ...
    getInfo() {
        return {
            "id": "halocode_mbuild_rangingsensor",
            "targets": [
                "haloboard",
                "cyberpi"
            ],
...
export default ExtHalocodeMbuildRangingsensor;