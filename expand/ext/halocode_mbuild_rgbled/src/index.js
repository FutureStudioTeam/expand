...
const halocodeMbuildRgbledHaloboardUploadMiddlewareTemp =
    /**
     ...
     */
    (app, device, data, logHandler, progressHandle, finishHandler, errHandler) => {
        // TODO
    };
...
function updateShareDatas() {
    ...
    // rgb led
    let mbuildRgbLedTable = [
        new onlineDataStructure("BLOCK_1565078276055", "mbuild.rgb_led.show", [0, 0, 0, 100, 1]),
        new onlineDataStructure("BLOCK_1569143379816", "mbuild.rgb_led.__set_r_g_b", [0, 100, 1]),
        new onlineDataStructure("BLOCK_1565078755274", "mbuild.rgb_led.__change_r_g_b", [0, 100, 1]),
        new onlineDataStructure("BLOCK_1565078777662", "mbuild.rgb_led.__get_r_g_b", [1], {
            default: "array"
        }),
    ]
    ...
    onlineManager.updateOnlineTable("add", mbuildRgbLedTable);
}
...
class ExtHalocodeMbuildRgbled {

    constructor() {
        this.funcs = {
            'block1565078276055CodesCode': (args) => {
                let color = args.color_2;
                let r = parseInt(color.substr(2, 2), 16);
                let g = parseInt(color.substr(4, 2), 16);
                let b = parseInt(color.substr(6, 2), 16);

                if (args.number_3 == "None" || (args.number_3 < 0)) {
                    args.number_3 = 0;
                }
                return `mbuild.rgb_led.show(${r}, ${g}, ${b}, ${args.index})
time.sleep(${args.number_3})
mbuild.rgb_led.show(0, 0, 0, ${args.index})`;
            },
            'BLOCK_1565078276055': {
            ...
            'block1565078427193CodesCode': (args) => {
                let color = args.color_2;
            ...
            'BLOCK_1565078533128': {
                onRun: async (args, app, device, block) => {
                    ...
                    let opcode = "BLOCK_1565078276055";
                    let para = [0, 0, 0, Number(args.index)];
            ...
            'BLOCK_1569143379816': {
                onRun: async (args, app, device, block) => {
                    ...
                    let opcode = "BLOCK_1569143379816";
                    let para = [colorTable[args.color], Number(args.value), Number(args.index)];
            ...
            'BLOCK_1565078755274': {
                onRun: async (args, app, device, block) => {
                    ...
                    let opcode = "BLOCK_1565078755274";
                    let para = [colorTable[args.color], Number(args.value), Number(args.index)];
                    ...
                    "options": {
                        "upload": {
                            "middlewares": [{
                                ...
                                "func": halocodeMbuildRgbledHaloboardUploadMiddlewareTemp
                            }]
                        }
                    }
                },
...
export default ExtHalocodeMbuildRgbled;