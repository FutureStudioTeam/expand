...
const halocodeMbuildServodriverHaloboardUploadMiddlewareTemp =
    /**
...
function updateShareDatas() {
    ...
    let mbuildServoTable = [
        // {angle}, {index}
        new onlineDataStructure("BLOCK_1550543186478", "mbuild.servo_driver.set_angle", [0, 1]),
        // {angle}, {index}
        new onlineDataStructure("BLOCK_1550543202398", "mbuild.servo_driver.change_angle", [0, 1]),
        new onlineDataStructure("BLOCK_1550543222423", "mbuild.servo_driver.get_angle", [1], {
            default: "int"
        }),
    ]

    onlineManager.updateOnlineTable("add", mbuildServoTable);
}
...
class ExtHalocodeMbuildServodriver {

    constructor() {
        this.funcs = {
            'BLOCK_1550543186478': {
                onRun: async (args, app, device, block) => {
                    let opcode = "BLOCK_1550543186478";
            ...
            'BLOCK_1550543202398': {
                onRun: async (args, app, device, block) => {
                    let opcode = "BLOCK_1550543202398";
                    let para = [Number(args.angle), Number(args.index)];
            ...
            'BLOCK_1550543222423': {
                onRun: async (args, app, device, block) => {
                    ...
                    let opcode = "BLOCK_1550543222423";
    ...
    getInfo() {
        return {
            "id": "halocode_mbuild_servodriver",
            "targets": [{
                    "name": "haloboard",
                    "options": {
                        "upload": {
                            "middlewares": [{
                                "name": "temp",
                                "func": halocodeMbuildServodriverHaloboardUploadMiddlewareTemp
                            }]
                        }
                    }
                },
...
export default ExtHalocodeMbuildServodriver;