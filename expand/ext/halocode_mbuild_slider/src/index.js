...
const halocodeMbuildSliderHaloboardUploadMiddlewareTemp =
    /**
...
function updateShareDatas() {
    ...
    let mbuildSliderTable = [
        new onlineDataStructure("BLOCK_1552140810502", "mbuild.slider.get_value", [1], {
            default: "int"
        }),
    ]

    onlineManager.updateOnlineTable("add", mbuildSliderTable);
}
        ...
        this.funcs = {
            'BLOCK_1552140810502': {
                onRun: (args, app, device, block) => {
                    ...
                    let opcode = "BLOCK_1552140810502";
...
export default ExtHalocodeMbuildSlider;