...
const halocodeMbuildSoilMoistureSensorHaloboardUploadMiddlewareTemp =
    /**
...
function updateShareDatas() {
    ...
    let mbuildSoilMoistureTable = [
        new onlineDataStructure("BLOCK_1560256139660", "mbuild.soil_moisture.get_humidity", [1], {
            default: "int"
        }),
    ]

    onlineManager.updateOnlineTable("add", mbuildSoilMoistureTable);
}
...
class ExtHalocodeMbuildSoilMoistureSensor {
        ...
        this.funcs = {
            'BLOCK_1560256139660': {
                onRun: (args, app, device, block) => {
                    ...
                    let opcode = "BLOCK_1560256139660";
    ...
    getInfo() {
        return {
            "id": "halocode_mbuild_soil_moisture_sensor",
            "targets": [
                "haloboard",
                "cyberpi"
            ],
...
export default ExtHalocodeMbuildSoilMoistureSensor;