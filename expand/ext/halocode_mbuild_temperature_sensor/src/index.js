...
const halocodeMbuildTemperatureSensorHaloboardUploadMiddlewareTemp =
    /**
...
function updateShareDatas() {
    ...
    let mbuildTempSensorTable = [
        // "fahrenheit"
        new onlineDataStructure("BLOCK_1560257762145", "mbuild.temp_sensor.get_temperature", ["celsius", 1], {
            default: "int"
        }),
        new onlineDataStructure("BLOCK_1560258599092", "mbuild.temp_sensor.get_temperature", ["fahrenheit", 1], {
            default: "int"
        }),
    ]

    onlineManager.updateOnlineTable("add", mbuildTempSensorTable);
}
...
class ExtHalocodeMbuildTemperatureSensor {
        ...
        this.funcs = {
            'BLOCK_1560257762145': {
                onRun: (args, app, device, block) => {
                    ...
                    let opcode = "BLOCK_1560257762145";
                    onlineManager.parasUpdate(opcode, ["celsius", index], args.index);
            ...
            'BLOCK_1560258599092': {
                onRun: (args, app, device, block) => {
                    ...
                    let index = Number(args.index)
                    let opcode = "BLOCK_1560258599092";
                    onlineManager.parasUpdate(opcode, ["fahrenheit", index], args.index);
                    let value = onlineManager.getValue(opcode, args.index);
    ...
    getInfo() {
        return {
            "id": "halocode_mbuild_temperature_sensor",
            "targets": [
                "haloboard",
                "cyberpi"
            ],
...
export default ExtHalocodeMbuildTemperatureSensor;