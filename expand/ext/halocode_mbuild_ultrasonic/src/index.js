...
const halocodeMbuildUltrasonicHaloboardUploadMiddlewareTemp =
    /**
...
function updateShareDatas() {
    ...
    let mbuildUltrasonicTable = [
        new onlineDataStructure("BLOCK_1552140890585", "mbuild.ultrasonic_sensor.get_distance", [], {
            default: "float1"
        }),
    ];
...
class ExtHalocodeMbuildUltrasonic {
        ...
        this.funcs = {
            'BLOCK_1552140890585': {
                onRun: (args, app, device, block) => {
                    ...
                    const opcode = "BLOCK_1552140890585";
...
export default ExtHalocodeMbuildUltrasonic;