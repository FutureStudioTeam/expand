...
const halocodeOriginalityHaloboardUploadMiddlewareTemp =
    /**
...
const disableBlocks = {
    debug: [],
    upload: ["halocode_originality.BLOCK_1583718811892"]
};
...
class ExtHalocodeOriginality {
            ...
            'BLOCK_1583718811892': {
                onRun: (args, app, device, block) => {
                    ...
                    if ((Math.abs(value_x) > 3) || (Math.abs(value_y) > 3)) {
                        ...
                        return device.updateSpriteByName(args.SPRITE, {
                            x: Number(move_x),
                            y: Number(move_y)
                        });
                    }
    ...
    getInfo() {
        return {
            ...
            "targets": [{
                ...
                "options": {
                    "upload": {
                        "middlewares": [{
                            "name": "temp",
                            "func": halocodeOriginalityHaloboardUploadMiddlewareTemp
                        }]
                    }
                }
            }],
            ...
            "mustLoginBlocks": [],
            "disabledOffline": [
                "halocode_originality.BLOCK_1583718811892"
            ],
            "disabledOnline": []
        };
    }
...
export default ExtHalocodeOriginality;