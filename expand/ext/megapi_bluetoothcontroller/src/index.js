...
const disableBlocks = {
    debug: ["megapi_bluetoothcontroller.getBluetoothJoystickValue", "megapi_bluetoothcontroller.checkBluetoothKey"],
    upload: []
};
...
class ExtMegapiBluetoothcontroller {
...
export default ExtMegapiBluetoothcontroller;