...
const disableBlocks = {
    debug: ["megapipro_24gjoystickcontroller.get24JoystickValue", "megapipro_24gjoystickcontroller.check24JoystickKey"],
    upload: []
};
...
class ExtMegapipro24Gjoystickcontroller {

    constructor() {
        this.funcs = {
            'get24JoystickValueCodesCode': (args) => {
            ...
            'check24JoystickKeyCodesCode': (args) => {
    ...
    getInfo() {
        return {
            "id": "megapipro_24gjoystickcontroller",
            "targets": [{
                "name": "megapipro",
                "options": {
                    "upload": {
...
export default ExtMegapipro24Gjoystickcontroller;