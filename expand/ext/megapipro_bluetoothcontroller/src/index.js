...
const disableBlocks = {
    debug: ["megapipro_bluetoothcontroller.getBluetoothJoystickValue", "megapipro_bluetoothcontroller.checkBluetoothKey"],
    upload: []
};
...
class ExtMegapiproBluetoothcontroller {

    constructor() {
        this.funcs = {
            'getBluetoothJoystickValueCodesCode': (args) => {
                return `MePS2.MeAnalog(${keyValueMap[args.AXIS]})`
            },
            ...
            'checkBluetoothKeyCodesCode': (args) => {
                return `MePS2.ButtonPressed(${keyValueMap[args.AXIS]})`
            },
            'checkBluetoothKey': {
                onRun: (args, app, device, block) => {
    ...
    getInfo() {
        return {
            "id": "megapipro_bluetoothcontroller",
            "targets": [{
                    "name": "megapipro",
                    "options": {
                        "upload": {
            ...
            "disabledOffline": [],
            "disabledOnline": [
                "megapipro_bluetoothcontroller.getBluetoothJoystickValue",
                "megapipro_bluetoothcontroller.checkBluetoothKey"
            ]
        };
    }
...
export default ExtMegapiproBluetoothcontroller;