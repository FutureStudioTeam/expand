...
const cates = (facepanels) => ([
    CATEGORY_ACTION(facepanels), CATEGORY_SHOW(facepanels), CATEGORY_PLAY(facepanels), CATEGORY_SENSOR(facepanels), events(facepanels), control(facepanels), operators(facepanels), data(facepanels), myBlocks(facepanels)
]);
