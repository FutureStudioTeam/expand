const blocks = (extFacePanels) => ([{
        ...
        "codes": {
            "python": {
                "sections": {
                    "from": `from mbuild.smartservo import smartservo_class`,
                    "new_class": `smartservo_{NUM} = smartservo_class(\"{PORT}\", \"{INDEX}\")`
                }
            }
        },
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `smartservo_{NUM}.move({POSITION}, {SPEED})`
            }
        },
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `smartservo_{NUM}.move_to({POSITION}, {SPEED})`
            }
        },
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `smartservo_{NUM}.set_power({POWER})`
            }
        },
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `smartservo_{NUM}.get_value(\"{TYPE}\")`
            }
        },
