...
class ExtNovapiMbuildLightSensor {
        ...
        this.funcs = {
            'BLOCK_1574146082471': {
                onRun: async (args, app, device, block) => {
                    let scriptString = [];
                    scriptString = `from mbuild.light_sensor import light_sensor_class
light_sensor_${args.index} = light_sensor_class("${args.PORT}", "${args.NUM}")`
            ...
            'BLOCK_1559813805438': {
                onRun: async (args, app, device, block) => {
                    let scriptString = [];
                    scriptString = `value = light_sensor_${args.index}.get_value()
...
export default ExtNovapiMbuildLightSensor;