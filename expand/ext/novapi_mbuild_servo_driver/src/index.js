...
class ExtNovapiMbuildServoDriver {
        ...
        this.funcs = {
            'BLOCK_1574237370682': {
                onRun: async (args, app, device, block) => {
                    let scriptString = [];
                    scriptString = `from mbuild.servo_driver import servo_driver_class
servo_driver_${args.index} = servo_driver_class("${args.PORT}", "${args.NUM}")`
            ...
            'BLOCK_1550543186478': {
                onRun: async (args, app, device, block) => {
                    let scriptString = [];
                    scriptString = `servo_driver_${args.index}.set_angle(${args.angle})
`
                    await OnlineProtocol.writeScript(device, scriptString);
                }
            },
            'BLOCK_1550543202398': {
                onRun: async (args, app, device, block) => {
                    let scriptString = [];
                    scriptString = `servo_driver_${args.index}.change_angle(${args.angle})
`
                    await OnlineProtocol.writeScript(device, scriptString);
                }
            },
            'BLOCK_1550543213773': {
                onRun: async (args, app, device, block) => {
                    let scriptString = [];
                    scriptString = `servo_driver_${args.index}.set_angle(0)
`
                    await OnlineProtocol.writeScript(device, scriptString);
                }
            },
            'BLOCK_1550543222423': {
                onRun: async (args, app, device, block) => {
                    let scriptString = [];
                    scriptString = `value = servo_driver_${args.index}.get_angle()
...
export default ExtNovapiMbuildServoDriver;