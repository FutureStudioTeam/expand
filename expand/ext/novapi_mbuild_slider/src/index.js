        ...
        this.funcs = {
            'BLOCK_1574412981531': {
                onRun: async (args, app, device, block) => {
                    let scriptString = [];
                    scriptString = `from mbuild.slider import slider_class
slider_${args.index} = slider_class("${args.PORT}", "${args.NUM}")`
            ...
            'BLOCK_1552140810502': {
                onRun: async (args, app, device, block) => {
                    let scriptString = [];
                    scriptString = `value = slider_${args.index}.get_value()
...
export default ExtNovapiMbuildSlider;