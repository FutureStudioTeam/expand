...
class ExtNovapiMbuildSoilMoisture {
        ...
        this.funcs = {
            'BLOCK_1574318271859': {
                onRun: async (args, app, device, block) => {
                    let scriptString = [];
                    scriptString = `from mbuild.soil_moisture import soil_moisture_class
soil_moisture_${args.index} = soil_moisture_class("${args.PORT}", "${args.NUM}")`
            ...
            'BLOCK_1560256139660': {
                onRun: async (args, app, device, block) => {
                    let scriptString = [];
                    scriptString = `value = soil_moisture_${args.index}.get_humidity()
online_debug_respond(value)`
    ...
    getInfo() {
        return {
            "id": "novapi_mbuild_soil_moisture",
            "targets": [
                "novapi"
            ],
            "codeTypes": [
...
export default ExtNovapiMbuildSoilMoisture;