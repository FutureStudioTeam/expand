...
class ExtNovapiMbuildSoundSensor {
        ...
        this.funcs = {
            'BLOCK_1574411641298': {
                onRun: async (args, app, device, block) => {
                    let scriptString = [];
                    scriptString = `from mbuild.sound_sensor import sound_sensor_class
sound_sensor_${args.index} = sound_sensor_class("${args.PORT}", "${args.NUM}")`
            ...
            'BLOCK_1559814177378': {
                onRun: async (args, app, device, block) => {
                    let scriptString = [];
                    scriptString = `value = sound_sensor_${args.index}.get_loudness()
...
export default ExtNovapiMbuildSoundSensor;