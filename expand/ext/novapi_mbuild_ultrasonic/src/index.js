...
class ExtNovapiMbuildUltrasonic {
        ...
        this.funcs = {
            'BLOCK_1574660558814': {
                onRun: async (args, app, device, block) => {
                    let scriptString = [];
                    scriptString = `from mbuild.ultrasonic_sensor import ultrasonic_sensor_class
ultrasonic_sensor_${args.index} = ultrasonic_sensor_class("${args.PORT}", "${args.NUM}")`
            ...
            'BLOCK_1552140890585': {
                onRun: async (args, app, device, block) => {
                    let scriptString = [];
                    scriptString = `value = ultrasonic_sensor_${args.index}.get_distance()
...
export default ExtNovapiMbuildUltrasonic;