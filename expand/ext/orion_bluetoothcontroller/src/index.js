...
const disableBlocks = {
    debug: ["orion_bluetoothcontroller.getBluetoothJoystickValue", "orion_bluetoothcontroller.checkBluetoothKey"],
    upload: []
};
...
class ExtOrionBluetoothcontroller {
...
export default ExtOrionBluetoothcontroller;