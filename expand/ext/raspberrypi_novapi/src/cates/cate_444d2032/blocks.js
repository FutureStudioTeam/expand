const blocks = (extFacePanels) => ([{
        ...
        "codes": {
            "python": {
                "code": `__encoder_motor_{PORT}.set_power({POWER})`,
                "sections": {
                    "from": `from hardware.mbuild.encoder_motor import encoder_motor_class`,
                    "new_class": `__encoder_motor_{PORT} = encoder_motor_class(\"{PORT}\", \"INDEX1\", \"__encoder_motor_{PORT}\")`
                }
            }
        },
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `__encoder_motor_{PORT}.move({POSITION}, {SPEED})`,
                "sections": {
                    "from": `from hardware.mbuild.encoder_motor import encoder_motor_class`,
                    "new_class": `__encoder_motor_{PORT} = encoder_motor_class(\"{PORT}\", \"INDEX1\", \"__encoder_motor_{PORT}\")`
                }
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `__encoder_motor_{PORT}.move_to({POSITION}, {SPEED})`,
                "sections": {
                    "from": `from hardware.mbuild.encoder_motor import encoder_motor_class`,
                    "new_class": `__encoder_motor_{PORT} = encoder_motor_class(\"{PORT}\", \"INDEX1\", \"__encoder_motor_{PORT}\")`
                }
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `__encoder_motor_{PORT}.set_speed({SPEED})`,
                "sections": {
                    "from": `from hardware.mbuild.encoder_motor import encoder_motor_class`,
                    "new_class": `__encoder_motor_{PORT} = encoder_motor_class(\"{PORT}\", \"INDEX1\", \"__encoder_motor_{PORT}\")`
                }
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `(__encoder_motor_{PORT}.get_value(\"speed\"))`,
                "sections": {
                    "from": `from hardware.mbuild.encoder_motor import encoder_motor_class`,
                    "new_class": `__encoder_motor_{PORT} = encoder_motor_class(\"{PORT}\", \"INDEX1\", \"__encoder_motor_{PORT}\")`
                }
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `(__encoder_motor_{PORT}.get_value(\"angle\"))`,
                "sections": {
                    "from": `from hardware.mbuild.encoder_motor import encoder_motor_class`,
                    "new_class": `__encoder_motor_{PORT} = encoder_motor_class(\"{PORT}\", \"INDEX1\", \"__encoder_motor_{PORT}\")`
                }
