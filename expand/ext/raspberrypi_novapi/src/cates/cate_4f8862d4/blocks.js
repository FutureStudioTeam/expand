const blocks = (extFacePanels) => ([{
        ...
        "codes": {
            "python": {
                "sections": {
                    "from": `from hardware.mbuild.dual_rgb_sensor import dual_rgb_sensor_class`,
                    "new_class": `__dual_rgb_sensor_{NUM} = dual_rgb_sensor_class(\"{PORT}\", \"{INDEX}\", \"__dual_rgb_sensor_{NUM}\")`
                }
            }
        },
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `__dual_rgb_sensor_{NUM}.set_motor_diff_speed_kp({KP})`
            }
        },
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `__dual_rgb_sensor_{NUM}.set_led_color(\"{COLOR}\")`
            }
        },
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `(__dual_rgb_sensor_{NUM}.is_color(\"{CHANNEL}\", \"{COLOR}\"))`
            }
        },
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `(__dual_rgb_sensor_{NUM}.is_state(\"{STATE}\"))`
            }
        },
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `(__dual_rgb_sensor_{NUM}.is_on_background(\"{CHANNEL}\"))`
            }
        },
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `__dual_rgb_sensor_{NUM}.get_intensity(\"{CHANNEL}\")`
            }
        },
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `__dual_rgb_sensor_{NUM}.get_offset_track_value()`
            }
        },
    ...
    },
    {
        ...
        "codes": {
            "python": {
                "code": `(__dual_rgb_sensor_{NUM}.get_motor_diff_speed())`
            }
        },
