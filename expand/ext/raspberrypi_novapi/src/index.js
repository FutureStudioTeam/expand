...
const disableBlocks = {
    debug: ["raspberrypi_novapi.timer", "raspberrypi_novapi.timer_reset", "raspberrypi_novapi.motion_sensor_acc", "raspberrypi_novapi.motion_sensor_gyro", "raspberrypi_novapi.motion_sensor_angle", "raspberrypi_novapi.motion_sensor_set_threshold", "raspberrypi_novapi.motion_sensor_check_shake", "raspberrypi_novapi.motion_sensor_reset_rotation", "raspberrypi_novapi.compitition_mode", "raspberrypi_novapi.DRGB_INIT", "raspberrypi_novapi.DRGB_SET_SENSOR_KP", "raspberrypi_novapi.DRGB_SET_SENSOR_COLOR", "raspberrypi_novapi.DRGB_CHECK_COLOR", "raspberrypi_novapi.DRGB_SENSOR_STATUS", "raspberrypi_novapi.DRGB_BACKGROUND_DETECTED", "raspberrypi_novapi.DRGB_GET_INTENSITY", "raspberrypi_novapi.DRGB_GET_POSITION_OFFSET", "raspberrypi_novapi.DRGB_GET_POSITION_OFFSET_KP", "raspberrypi_novapi.POWER_EXPAND_DCmotor_power", "raspberrypi_novapi.POWER_EXPAND_DCmotor_stop", "raspberrypi_novapi.POWER_EXPAND_BLmotor_power", "raspberrypi_novapi.POWER_EXPAND_BLmotor_stop", "raspberrypi_novapi.POWER_EXPAND_solenoidvalve", "raspberrypi_novapi.encoder_motor_power", "raspberrypi_novapi.encoder_motor_move", "raspberrypi_novapi.encoder_motor_move_to", "raspberrypi_novapi.encoder_motor_speed", "raspberrypi_novapi.encoder_motor_get_speed", "raspberrypi_novapi.encoder_motor_get_pos", "raspberrypi_novapi.smartservo_init", "raspberrypi_novapi.smartservo_move", "raspberrypi_novapi.smartservo_move_to", "raspberrypi_novapi.smartservo_set_power", "raspberrypi_novapi.SMARTSERVO_POWER", "raspberrypi_novapi.BT_CONTROLLER_BUTTON_PRESSED", "raspberrypi_novapi.BT_CONTROLLER_JOYSTICK", "raspberrypi_novapi.distance_sensor_init", "raspberrypi_novapi.distance_sensor_get_data"],
    upload: []
};
...
export default ExtRaspberrypiNovapi;