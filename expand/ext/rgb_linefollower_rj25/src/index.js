...
const disableBlocks = {
    debug: ["rgb_linefollower_rj25.rgb_linefollow_init", "rgb_linefollower_rj25.rgb_linefollow_turning_sens", "rgb_linefollower_rj25.rgb_linefollow_speed_diff", "rgb_linefollower_rj25.rgb_linefollow_sensor_status", "rgb_linefollower_rj25.rgb_linefollow_background_detect", "rgb_linefollower_rj25.rgb_linefollow_set_color", "rgb_linefollower_rj25.rgb_linefollow_get_data"],
    upload: []
};
...
class ExtRgbLinefollowerRj25 {
    ...
    constructor() {
        this.funcs = {
            ...
            'rgbLinefollowTurningSensCodesCode': (args) => {
                if (args.SENS == "None") {
                    args.SENS = 0;
                } else if (Number(args.SENS) < 0) {
                    args.SENS = 0;
                } else if (Number(args.SENS) > 1) {
                    args.SENS = 1;
                }
                return `
LightSensorRGB_${args.SENSOR_ID}.setKp(${args.SENS});`
            },
            'rgb_linefollow_turning_sens': {
                onRun: (args, app, device, block) => {
                    // TODO
                }
            },
            ...
            'rgb_linefollow_background_detect': {
                onRun: (args, app, device, block) => {
                    // TODO
                },
                onMonitor: (app, device, block) => {
            ...
            'rgb_linefollow_set_color': {
                onRun: (args, app, device, block) => {
                    // TODO
                }
            },
            'rgb_linefollow_get_data': {
                onRun: (args, app, device, block) => {
                    // TODO
                },
                onMonitor: (app, device, block) => {
...
export default ExtRgbLinefollowerRj25;