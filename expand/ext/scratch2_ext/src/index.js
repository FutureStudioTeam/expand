...
const disableBlocks = {
    debug: [],
    upload: ["scratch2_ext.BLOCK_1573546824559", "scratch2_ext.BLOCK_1577182936545"]
};
...
class ExtScratch2Ext {
        ...
        this.funcs = {
            'BLOCK_1573546824559': {
                onRun: (args, app, device, block) => {
                    ...
                    if (currentKeyCode == parseInt(args.keyMenu)) {
                        return true;
                    } else {
                        return false;
                    }
            ...
            'BLOCK_1577182936545': {
                onRun: (args, app, device, block) => {
                    if (args.keyMenu == 'any') {
                        return Object.keys(keyPressMap).some(key => {
                            return keyPressMap[key] == true;
                        })
                    } else {
                        return keyPressMap[args.keyMenu] == true;
                    }
                }
            }
        };
    ...
    getInfo() {
        return {
            ...
            "mustLoginBlocks": [],
            "disabledOffline": [
                "scratch2_ext.BLOCK_1573546824559",
                "scratch2_ext.BLOCK_1577182936545"
            ],
            "disabledOnline": []
        };
    }
