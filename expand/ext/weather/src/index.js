        ...
        buttons: [{
            ...
            },
            {
                ...
                handle: (ctx) => {
                    ...
                    if (citycode && options && options.length > 0) {
                        for (const key in options) {
                            const option = options[key];
                            if (option.value === citycode) {
    ...
    constructor() {
        this.funcs = {
            'customWidgetE7B76771': (widget) => {
                ...
                widget.showEditor_ = () => {
                    DialogWidget(widget, 'weatherDialog', 'weather.CHOOSE_CITY', getOptions);
                }
            },
            'max_temperature_c': {
                onRun: async (args, app, device, block) => {
                    let cityID = JSON.parse(args.CITY)[1];
                    return await getWeather(cityID, 0);
                },
            ...
            'min_temperature_c': {
                onRun: async (args, app, device, block) => {
                    return await getWeather(JSON.parse(args.CITY)[1], 1);
                },
                onMonitor: (app, device, block) => {
                    // TODO
                }
            ...
            'max_temperature_f': {
                onRun: async (args, app, device, block) => {
                    return await getWeather(JSON.parse(args.CITY)[1], 2);
                },
                onMonitor: (app, device, block) => {
                    // TODO
                }
            ...
            'min_temperature_f': {
                onRun: async (args, app, device, block) => {
                    return await getWeather(JSON.parse(args.CITY)[1], 3);
                },
                onMonitor: (app, device, block) => {
                    // TODO
                }
            ...
            'humidity': {
                onRun: async (args, app, device, block) => {
                    return await getWeather(JSON.parse(args.CITY)[1], 5);
                },
                onMonitor: (app, device, block) => {
                    // TODO
                }
            ...
            'temperature': {
                onRun: async (args, app, device, block) => {
                    return await getWeather(JSON.parse(args.CITY)[1], 4);
                },
                onMonitor: (app, device, block) => {
                    // TODO
                }
            ...
            'sunrise': {
                onRun: async (args, app, device, block) => {
                    return await getWeather(JSON.parse(args.CITY)[1], parseInt(args.TIME) + 7);
                },
                onMonitor: (app, device, block) => {
                    // TODO
                }
            ...
            'sunset': {
                onRun: async (args, app, device, block) => {
                    return await getWeather(JSON.parse(args.CITY)[1], parseInt(args.TIME) + 10);
                },
                onMonitor: (app, device, block) => {
                    // TODO
                }
            },
            'customWidgetB25Ca5F4': (widget) => {
                const getOptions = async (value) => {
                ...
                widget.showEditor_ = () => {
                    DialogWidget(widget, 'meteorologicalDialog', 'weather.CHOOSE_METEOR', getOptions);
                }
            },
            'meteorological': {
                onRun: async (args, app, device, block) => {
                    return await getAirQuality(JSON.parse(args.METEOROLOGICAL)[1], args.AIRQUALITY);
                },
                onMonitor: (app, device, block) => {
                    // TODO
                }
